...
format: 
  revealjs:
    ...
    logo: "figures/logos/UNAL.png"
    header-logo: "figures/logos/ENSGSI.png"
    header: '[Mercadotecnia Innovacion e Emprendimiento 2025](#/TOC)'
    slide-level: 3
...
## Technology Readiness → Maturity  {background-image="figures/00.png" background-size="65%" background-position="100% 50%" }

<br><br><br><br>

The industrial <br> emergence mapping framework 
...
:::{.footer}
Phaal, R., O’Sullivan, E., Routley, M., Ford, S., Probert, D., 2011. <br>A framework for mapping industrial emergence. Technological Forecasting and Social Change 78, 217–230. [https://doi.org/10.1016/j.techfore.2010.06.018](https://doi.org/10.1016/j.techfore.2010.06.018)
:::
...
![[Technology Readiness Levels (TRL)](https://www.esa.int/Enabling_Support/Space_Engineering_Technology/Shaping_the_Future/Technology_Readiness_Levels_TRL)](figures/TRL-00.png){width=100% fig-align='center'}

## Technology Readiness → The Valley of Death

![](figures/TRL-01.png){width="100%" fig-align="center"}
...
::: {.r-stack}
![](figures/NPD-0.png){width="70%" fig-align="right"}


![](figures/NPD-1.png){.fragment .absolute width="500"  top=100 left=0}

![](figures/NPD-2.png){.fragment width="500" .absolute  top=150 left=0}

![](figures/NPD-3.png){.fragment .absolute top=180 left=0 width="500" }

![](figures/NPD-4.png){.fragment .absolute top=200 left=0 width="500" }

![](figures/NPD-5.png){.fragment  .absolute top=210 left=0 width="500"}
:::
...
## UNAL → Scientific & Patent databases

![](figures/UNAL/01.png){width="400" fig-align="center"}

[`https://bases.unal.edu.co/`](https://bases.unal.edu.co/){target="_blank"}
...
::: {.r-stack}
![](figures/Patent-00.png){fig-align="center" width="80%"}


![](figures/Patent.png){.fragment fig-align="center" width="90%"}
:::

## Why a patent is pertinent?


![](figures/Patent-01.png){fig-align="center" width="80%"}


# Goal for you 🦸‍♂ 🦸🏻‍♀️!

>  **Exploration of Scientific/Patent databases**


## Exploration of Scientific/Patent databases


1. Go to Web of Science and make a research for Patents/Scientific Articles!
1. Explore the domaine of patents using the WoS tools. 
1. Select at least **1 pertinent patent/scientific article**   regarding your Idea!
...
## Exemples of Patent databases

##  Google Patents

![](figures/UNAL/Google-patents.png){width=80% fig-align=center}

[🔗 `https://patents.google.com/`](https://patents.google.com/){target="_blank"}

##  Espacenet

![](figures/UNAL/Espacenet.png){width=50% fig-align=center}

[🔗 `https://worldwide.espacenet.com/`](https://worldwide.espacenet.com/){target="_blank"}


##  Web Of Science Patent Database 

>⚠️ For those Universities that have access!

##  Web Of Science Patent Database {.exclude}

:::{layout="[50,-2,50]" layout-valign="center"}
:::{}

1. 
[🔗 Access to UL <br>`https://bases.unal.edu.co/`](https://bases.unal.edu.co/){target="_blank"}

2. Search for `Web Of Science` 

:::

![](figures/UNAL/01.png){fig-align="center" width="60%"}
